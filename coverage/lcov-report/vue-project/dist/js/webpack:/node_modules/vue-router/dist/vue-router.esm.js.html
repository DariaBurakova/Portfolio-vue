...
<head>
    <title>Code coverage report for vue-project/dist/js/webpack:/node_modules/vue-router/dist/vue-router.esm.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../../../index.html">All files</a> / <a href="index.html">vue-project/dist/js/webpack:/node_modules/vue-router/dist</a> vue-router.esm.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">0% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>0/838</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>0/884</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>0/799</span>
            </div>
...
<a name='L3145'></a><a href='#L3145'>3145</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >warn (c</span>ondition, message) {
  if (<span class="cstat-no" title="statement not covered" >process.env.NODE_ENV !== 'production' &amp;&amp; !condition) {</span>
...
var encode = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (s</span>tr) { <span class="cstat-no" title="statement not covered" >return encodeURIComponent(str)</span></span>
    ...
    .replace(commaRE, ','); };
&nbsp;
function <span class="fstat-no" title="function not covered" >decode (s</span>tr) {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >resolveQuery (</span>
  query,
  extraQuery,
...
<span class="cstat-no" title="statement not covered" >  for (var key in extraQuery) {</span>
    var value = <span class="cstat-no" title="statement not covered" >extraQuery[key];</span>
<span class="cstat-no" title="statement not covered" >    parsedQuery[key] = Array.isArray(value)</span>
...
&nbsp;
var castQueryParamValue = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (v</span>alue) { <span class="cstat-no" title="statement not covered" >return (value == null || typeof value === 'object' ? value : String(value)); };</span></span>
&nbsp;
...
&nbsp;
  query.split('&amp;').forEach(<span class="fstat-no" title="function not covered" >function (p</span>aram) {
    ...
    var val = <span class="cstat-no" title="statement not covered" >parts.length &gt; 0 ? decode(parts.join('=')) : <span class="cstat-no" title="statement not covered" >null;</span></span>
&nbsp;
...
function <span class="fstat-no" title="function not covered" >stringifyQuery (o</span>bj) {
  var res = <span class="cstat-no" title="statement not covered" >obj</span>
    ? Object.keys(obj)
      .map(<span class="fstat-no" title="function not covered" >function (k</span>ey) {
...
<span class="cstat-no" title="statement not covered" >        return encode(key) + '=' + encode(val)</span>
      ...
      .filter(<span class="fstat-no" title="function not covered" >function (x</span>) { <span class="cstat-no" title="statement not covered" >return x.length &gt; 0; })</span>
      .join('&amp;')
    : null;
...
function <span class="fstat-no" title="function not covered" >getFullPath (</span>
  ...
  var hash = <span class="cstat-no" title="statement not covered" >ref.<span class="cstat-no" title="statement not covered" >hash; if ( h</span>ash === void 0 ) hash = '';</span>
&nbsp;
  var stringify = <span class="cstat-no" title="statement not covered" >_stringifyQuery || stringifyQuery;</span>
<span class="cstat-no" title="statement not covered" >  return (path || '/') + stringify(query) + hash</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >isSameRoute (a</span>, b, onlyPath) {
...
<span class="cstat-no" title="statement not covered" >  if (!a || !b) { <span class="cstat-no" title="statement not covered" >return a === b }</span></span>
  var aKeys = <span class="cstat-no" title="statement not covered" >Object.keys(a).sort();</span>
  var bKeys = <span class="cstat-no" title="statement not covered" >Object.keys(b).sort();</span>
<span class="cstat-no" title="statement not covered" >  if (aKeys.length !== bKeys.length) {</span>
    return false
  }
  return aKeys.every(<span class="fstat-no" title="function not covered" >function (k</span>ey, i) {
    var aVal = <span class="cstat-no" title="statement not covered" >a[key];</span>
    var bKey = <span class="cstat-no" title="statement not covered" >bKeys[i];</span>
<span class="cstat-no" title="statement not covered" >    if (bKey !== key) { <span class="cstat-no" title="statement not covered" >return false }</span></span>
    var bVal = <span class="cstat-no" title="statement not covered" >b[key];</span>
    // query values can be null and undefined
<span class="cstat-no" title="statement not covered" >    if (aVal == null || bVal == null) { return aVal === bVal }</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >isIncludedRoute (c</span>urrent, target) {
<span class="cstat-no" title="statement not covered" >  return (</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >queryIncludes (c</span>urrent, target) {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >handleRouteEntered (r</span>oute) {
<span class="cstat-no" title="statement not covered" >  for (var i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; route.matched.length; i++) {</span>
    var record = <span class="cstat-no" title="statement not covered" >route.matched[i];</span>
<span class="cstat-no" title="statement not covered" >    for (var name in record.instances) {</span>
      var instance = <span class="cstat-no" title="statement not covered" >record.instances[name];</span>
      var cbs = <span class="cstat-no" title="statement not covered" >record.enteredCbs[name];</span>
<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" >      if (!instance || !cbs) { continue }</span></span>
      delete record.enteredCbs[name];
<span class="cstat-no" title="statement not covered" >      for (var i$1 = <span class="cstat-no" title="statement not covered" >0; i</span>$1 &lt; cbs.length; i$1++) {</span>
        if (!<span class="cstat-no" title="statement not covered" >instance._isBeingDestroyed) { cbs[i$1](instance); }</span>
      }
    }
  }
}
...
&nbsp;
function <span class="fstat-no" title="function not covered" >resolveProps (r</span>oute, config) {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >parsePath (p</span>ath) {
...
var compile_1 = <span class="cstat-no" title="statement not covered" >compile;</span>
 ...
 */
function <span class="fstat-no" title="function not covered" >compile (s</span>tr, options) {
 ...
 * @return {string}
 */
function <span class="fstat-no" title="function not covered" >encodeAsterisk (s</span>tr) {
<span class="cstat-no" title="statement not covered" >  return encodeURI(str).replace(/[?#]/g, <span class="fstat-no" title="function not covered" >function (c</span>) {</span>
<span class="cstat-no" title="statement not covered" >    return '%' + c.charCodeAt(0).toString(16).toUpperCase()</span>
  })
}
...
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function (o</span>bj, opts) {</span>
    ...
    var options = <span class="cstat-no" title="statement not covered" >opts || {};</span>
    var encode = <span class="cstat-no" title="statement not covered" >options.pretty ? encodeURIComponentPretty : encodeURIComponent;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; tokens.length; i++) {</span>
 ...
 * @return {!RegExp}
 */
function <span class="fstat-no" title="function not covered" >regexpToRegexp (p</span>ath, keys) {
 ...
 * @return {!RegExp}
 */
function <span class="fstat-no" title="function not covered" >arrayToRegexp (p</span>ath, keys, options) {
...
&nbsp;
  var regexp = <span class="cstat-no" title="statement not covered" >new RegExp('(?:' + parts.join('|') + ')', flags(options));</span>
&nbsp;
 ...
 * @return {!RegExp}
 */
function <span class="fstat-no" title="function not covered" >stringToRegexp (p</span>ath, keys, options) {
...
&nbsp;
  options = options || {};
&nbsp;
  var strict = <span class="cstat-no" title="statement not covered" >options.strict;</span>
...
<span class="cstat-no" title="statement not covered" >    next = extend({}, raw);</span>
    var params = <span class="cstat-no" title="statement not covered" >next.params;</span>
...
&nbsp;
  // relative params
<span class="cstat-no" title="statement not covered" >  if (!next.path &amp;&amp; next.params &amp;&amp; current) {</span>
<span class="cstat-no" title="statement not covered" >    next = extend({}, next);</span>
...
&nbsp;
  var parsedPath = <span class="cstat-no" title="statement not covered" >parsePath(next.path || '');</span>
  ...
  var path = <span class="cstat-no" title="statement not covered" >parsedPath.path</span>
    ...
    : basePath;
&nbsp;
  var query = <span class="cstat-no" title="statement not covered" >resolveQuery(</span>
    parsedPath.query,
    next.query,
...
var toTypes = <span class="cstat-no" title="statement not covered" >[String, Object];</span>
var eventTypes = <span class="cstat-no" title="statement not covered" >[String, Array];</span>
&nbsp;
...
&nbsp;
    var compareTarget = <span class="cstat-no" title="statement not covered" >route.redirectedFrom</span>
      ...
      : route;
&nbsp;
<span class="cstat-no" title="statement not covered" >    classes[exactActiveClass] = isSameRoute(current, compareTarget, this.exactPath);</span>
...
<span class="cstat-no" title="statement not covered" >      data.on = on;</span>
      ...
      var a = <span class="cstat-no" title="statement not covered" >findAnchor(this.$slots.default);</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >findAnchor (c</span>hildren) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  routes.forEach(<span class="fstat-no" title="function not covered" >function (r</span>oute) {</span>
<span class="cstat-no" title="statement not covered" >    addRouteRecord(pathList, pathMap, nameMap, route, parentRoute);</span>
  });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    route.pathToRegexpOptions || {};</span>
  var normalizedPath = <span class="cstat-no" title="statement not covered" >normalizePath(path, parent, pathToRegexpOptions.strict);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    for (var i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; aliases.length; ++i) {</span>
      var alias = <span class="cstat-no" title="statement not covered" >aliases[i];</span>
...
function <span class="fstat-no" title="function not covered" >compileRouteRegex (</span>
  ...
  var regex = <span class="cstat-no" title="statement not covered" >pathToRegexp_1(path, [], pathToRegexpOptions);</span>
  if (process.env.NODE_ENV !== 'production') {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >normalizePath (</span>
  path,
  parent,
  strict
) {
  if (!strict) { path = path.replace(/\/$/, ''); }
<span class="cstat-no" title="statement not covered" >  if (path[0] === '/') { return path }</span>
...
&nbsp;
  function <span class="fstat-no" title="function not covered" >addRoutes (r</span>outes) {
<span class="cstat-no" title="statement not covered" >    createRouteMap(routes, pathList, pathMap, nameMap);</span>
  }
&nbsp;
  function <span class="fstat-no" title="function not covered" >addRoute (p</span>arentOrRoute, route) {
    var parent = (typeof parentOrRoute !== <span class="cstat-no" title="statement not covered" >'object') ? nameMap[parentOrRoute] : undefined;</span>
    // $flow-disable-line
<span class="cstat-no" title="statement not covered" >    createRouteMap([route || parentOrRoute], pathList, pathMap, nameMap, parent);</span>
&nbsp;
    // add aliases of parent
    if (parent &amp;&amp; parent.alias.length) {
      createRouteMap(
        // $flow-disable-line route is defined if parent is
        parent.alias.map(<span class="fstat-no" title="function not covered" >function (a</span>lias) { <span class="cstat-no" title="statement not covered" >return ({ path: alias, children: [route] }); }),</span>
        pathList,
        pathMap,
        nameMap,
        parent
...
&nbsp;
  function <span class="fstat-no" title="function not covered" >getRoutes () {</span>
<span class="cstat-no" title="statement not covered" >    return pathList.map(<span class="fstat-no" title="function not covered" >function (p</span>ath) { <span class="cstat-no" title="statement not covered" >return pathMap[path]; })</span></span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return match({</span>
      ...
      var rawPath = <span class="cstat-no" title="statement not covered" >resolveRecordPath(path, record);</span>
      // 2. resolve params
      var resolvedPath = <span class="cstat-no" title="statement not covered" >fillParams(rawPath, params, ("redirect route with path \"" + rawPath + "\""));</span>
...
&nbsp;
  function <span class="fstat-no" title="function not covered" >alias (</span>
    record,
    location,
    matchAs
  ) {
    var aliasedPath = <span class="cstat-no" title="statement not covered" >fillParams(matchAs, location.params, ("aliased route with path \"" + matchAs + "\""));</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >resolveRecordPath (p</span>ath, record) {
...
&nbsp;
  ...
  router.app.$nextTick(<span class="fstat-no" title="function not covered" >function () {</span>
    var position = <span class="cstat-no" title="statement not covered" >getScrollPosition();</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >getScrollPosition () {</span>
  var key = <span class="cstat-no" title="statement not covered" >getStateKey();</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >getElementPosition (e</span>l, offset) {
  var docEl = <span class="cstat-no" title="statement not covered" >document.documentElement;</span>
  var docRect = <span class="cstat-no" title="statement not covered" >docEl.getBoundingClientRect();</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >normalizeOffset (o</span>bj) {
<span class="cstat-no" title="statement not covered" >  return {</span>
...
<span class="cstat-no" title="statement not covered" >        shouldScroll.offset &amp;&amp; typeof shouldScroll.offset === 'object'</span>
          ? shouldScroll.offset
          : {};
<span class="cstat-no" title="statement not covered" >      offset = normalizeOffset(offset);</span>
...
var NavigationFailureType = <span class="cstat-no" title="statement not covered" >{</span>
  redirected: 2,
  aborted: 4,
  cancelled: 8,
  duplicated: 16
...
&nbsp;
function <span class="fstat-no" title="function not covered" >createNavigationDuplicatedError (f</span>rom, to) {
  var error = <span class="cstat-no" title="statement not covered" >createRouterError(</span>
    from,
    to,
...
&nbsp;
function <span class="fstat-no" title="function not covered" >createNavigationAbortedError (f</span>rom, to) {
<span class="cstat-no" title="statement not covered" >  return createRouterError(</span>
    from,
    to,
...
&nbsp;
function <span class="fstat-no" title="function not covered" >stringifyRoute (t</span>o) {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >isError (e</span>rr) {
<span class="cstat-no" title="statement not covered" >  return Object.prototype.toString.call(err).indexOf('Error') &gt; -1</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >isNavigationFailure (e</span>rr, errorType) {
<span class="cstat-no" title="statement not covered" >  return (</span>
    isError(err) &amp;&amp;
    err._isRouter &amp;&amp;
...
&nbsp;
        var resolve = <span class="cstat-no" title="statement not covered" >once(<span class="fstat-no" title="function not covered" >function (r</span>esolvedDef) {</span>
          if (<span class="cstat-no" title="statement not covered" >isESModule(resolvedDef)) {</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >isESModule (o</span>bj) {
<span class="cstat-no" title="statement not covered" >  return obj.__esModule || (hasSymbol &amp;&amp; obj[Symbol.toStringTag] === '</span>Module')
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    route = this.router.match(location, this.current);</span>
  } catch (e) {
    this.errorCbs.forEach(<span class="fstat-no" title="function not covered" >function (c</span>b) {
...
<span class="cstat-no" title="statement not covered" >    throw e</span>
  ...
  var prev = <span class="cstat-no" title="statement not covered" >this.current;</span>
...
&nbsp;
  var ref = <span class="cstat-no" title="statement not covered" >resolveQueue(</span>
...
<span class="cstat-no" title="statement not covered" >  runQueue(queue, iterator, <span class="fstat-no" title="function not covered" >function () {</span></span>
    ...
    var enterGuards = <span class="cstat-no" title="statement not covered" >extractEnterGuards(activated);</span>
    var queue = <span class="cstat-no" title="statement not covered" >enterGuards.concat(this$1.router.resolveHooks);</span>
<span class="cstat-no" title="statement not covered" >    runQueue(queue, iterator, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      if (this$1.pending !== route) {</span>
<span class="cstat-no" title="statement not covered" >        return abort(createNavigationCancelledError(current, route))</span>
      }
...
<span class="cstat-no" title="statement not covered" >          handleRouteEntered(route);</span>
        });
      }
    });
  });
...
&nbsp;
History.prototype.teardown = <span class="fstat-no" title="function not covered" >function teardown () {</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >normalizeBase (b</span>ase) {
...
<span class="cstat-no" title="statement not covered" >      base = (baseEl &amp;&amp; baseEl.getAttribute('href')) || '/';</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >resolveQueue (</span>
  current,
  next
) {
  var i;
...
<span class="cstat-no" title="statement not covered" >    if (current[i] !== next[i]) {</span>
...
function <span class="fstat-no" title="function not covered" >extractGuards (</span>
  ...
  var guards = <span class="cstat-no" title="statement not covered" >flatMapComponents(records, <span class="fstat-no" title="function not covered" >function (d</span>ef, instance, match, key) {</span>
    var guard = <span class="cstat-no" title="statement not covered" >extractGuard(def, name);</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >extractGuard (</span>
  def,
  key
) {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >extractLeaveGuards (d</span>eactivated) {
<span class="cstat-no" title="statement not covered" >  return extractGuards(deactivated, 'beforeRouteLeave', bindGuard, true)</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >extractUpdateHooks (u</span>pdated) {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >extractEnterGuards (</span>
  activated
) {
...
<span class="cstat-no" title="statement not covered" >      return bindEnterGuard(guard, match, key)</span>
    }
  )
}
&nbsp;
function <span class="fstat-no" title="function not covered" >bindEnterGuard (</span>
  guard,
  match,
  key
) {
...
&nbsp;
    ...
    var fromRoute = <span class="cstat-no" title="statement not covered" >ref.current;</span>
...
function <span class="fstat-no" title="function not covered" >getLocation (b</span>ase) {
  var path = <span class="cstat-no" title="statement not covered" >window.location.pathname;</span>
  var pathLowerCase = <span class="cstat-no" title="statement not covered" >path.toLowerCase();</span>
  var baseLowerCase = <span class="cstat-no" title="statement not covered" >base.toLowerCase();</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >checkFallback (b</span>ase) {
...
function <span class="fstat-no" title="function not covered" >getHash () {</span>
  ...
  // empty path
<span class="cstat-no" title="statement not covered" >  if (index &lt; 0) { return '' }</span>
&nbsp;
...
function <span class="fstat-no" title="function not covered" >getUrl (p</span>ath) {
  ...
  var base = <span class="cstat-no" title="statement not covered" >i &gt;= 0 ? href.slice(0, i) : href;</span>
...
<span class="fstat-no" title="function not covered" >      function (e</span>rr) {
        if (<span class="cstat-no" title="statement not covered" >isNavigationFailure(err, NavigationFailureType.duplicated)) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >VueRouter.prototype.match = <span class="fstat-no" title="function not covered" >function match (r</span>aw, current, redirectedFrom) {</span>
...
<span class="cstat-no" title="statement not covered" >  if (history instanceof HTML5History || history instanceof HashHistory) {</span>
    var handleInitialScroll = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (r</span>outeOrError) {</span>
      var from = <span class="cstat-no" title="statement not covered" >history.current;</span>
      var expectScroll = <span class="cstat-no" title="statement not covered" >this$1.options.scrollBehavior;</span>
      var supportsScroll = <span class="cstat-no" title="statement not covered" >supportsPushState &amp;&amp; expectScroll;</span>
&nbsp;
      if (<span class="cstat-no" title="statement not covered" >supportsScroll &amp;&amp; 'fullPath' in routeOrError) {</span>
        handleScroll(this$1, routeOrError, from, false);
      }
    };
    var setupListeners = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function (r</span>outeOrError) {</span>
<span class="cstat-no" title="statement not covered" >      history.setupListeners();</span>
      handleInitialScroll(routeOrError);
    };
<span class="cstat-no" title="statement not covered" >    history.transitionTo(</span>
...
<span class="cstat-no" title="statement not covered" >  if (!route) {</span>
  ...
  return [].concat.apply(
    [],
    route.matched.map(<span class="fstat-no" title="function not covered" >function (m</span>) {
...
<span class="cstat-no" title="statement not covered" >  current = current || this.history.current;</span>
  var location = <span class="cstat-no" title="statement not covered" >normalizeLocation(to, current, append, this);</span>
  ...
  var base = <span class="cstat-no" title="statement not covered" >this.history.base;</span>
  var href = <span class="cstat-no" title="statement not covered" >createHref(base, fullPath, this.mode);</span>
<span class="cstat-no" title="statement not covered" >  return {</span>
    location: location,
    route: route,
    href: href,
...
&nbsp;
VueRouter.prototype.getRoutes = <span class="fstat-no" title="function not covered" >function getRoutes () {</span>
<span class="cstat-no" title="statement not covered" >  return this.matcher.getRoutes()</span>
};
&nbsp;
VueRouter.prototype.addRoute = <span class="fstat-no" title="function not covered" >function addRoute (p</span>arentOrRoute, route) {
<span class="cstat-no" title="statement not covered" >  this.matcher.addRoute(parentOrRoute, route);</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >createHref (b</span>ase, fullPath, mode) {
